...
// =============================================================================
// SECURITY PROPERTIES AND INVARIANTS (SIMPLIFIED)
// =============================================================================
...
// Display Integrity Property (Simplified)
pred DisplayIntegrity[d: Device] {
    // If MCU is compromised on Nano S, display cannot be trusted
    // SE-driven displays (Nano X, Stax) are more secure
    (d in NanoS) implies {
        (some mcu: MCU | mcu in d.components and mcu.compromised = True) implies
...
// Software Attack Scenario (Simplified)
pred SoftwareAttack[s: Software, u: User, d: Device] {
    ...
    d in u.trustsDisplay implies {
        // Hardware wallet display should still be secure on SE-driven devices
        (d in NanoX or d in Stax) implies {
...
// =============================================================================
// COMMANDS FOR ANALYSIS (OPTIMIZED FOR EFFICIENCY)
// =============================================================================

// Check security properties with reduced scope
...
// Find attack scenarios with reduced scope
run SecurityCompromised for 3 but 1 Device, 1 Attacker
run MultiVectorAttack for 3 but 1 Device, 1 Attacker, 1 Software, 1 User
run MinimalAttack for 3 but 1 Device, 1 Attacker

// Analyze specific device types with reduced scope
